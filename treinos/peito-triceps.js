...
function gerar()
{
    array_peito_superior = arrayAleatoria(exercicios_peito_superior)
    array_peito_medial = arrayAleatoria(exercicios_peito_medial)
    array_triceps = arrayAleatoria(exercicios_triceps)
    exerciciosPeito()
    exerciciosTriceps()
...
function isCross()
{
    ...
    {
        var mudar = array_peito_superior[3]
        return res1.innerHTML = mudar
    }

    else if (array_peito_superior[0] != 'crossover parte superior')
    {
        var nao_mudar = array_peito_superior[0]
        return res1.innerHTML = nao_mudar
    }
}

function fotosPeito()
{
    /*FOTOS PEITO SUPERIOR*/
